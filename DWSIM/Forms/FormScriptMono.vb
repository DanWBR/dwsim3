...
<System.Serializable()> Public Class FormScriptMono
...
#End Region
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        pd1.Document = New PrintDocument()
    ...
    Private Sub txtScript__KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub txtScript_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs)
...
#Region "Util methods"
    ...
    Private Sub selectItem()
        If Me.wordMatched Then
            Dim selstart As Integer = Me.txtScript.SelectionStart
            Dim prefixend As Integer = Me.txtScript.SelectionStart - typed.Length
            Dim suffixstart As Integer = Me.txtScript.SelectionStart + typed.Length

            If suffixstart >= Me.txtScript.Text.Length Then
                suffixstart = Me.txtScript.Text.Length
            End If

            Dim prefix As String = Me.txtScript.Text.Substring(0, prefixend)
            Dim fill As String = Me.listBoxAutoComplete.SelectedItem.ToString()
            Dim suffix As String = Me.txtScript.Text.Substring(suffixstart, Me.txtScript.Text.Length - suffixstart)

            Me.txtScript.Text = prefix & fill & suffix
            'Me.txtScript.Selection.LogicalSelStart = prefix.Length + fill.Length
            Me.txtScript.ScrollToCaret()
        End If
    End Sub

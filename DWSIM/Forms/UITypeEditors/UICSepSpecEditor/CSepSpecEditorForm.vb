...
Public Class CSepSpecEditorForm
    ...
    Private Sub CSepSpecEditorForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        For Each comp As DWSIM.ClassesBasicasTermodinamica.ConstantProperties In My.Application.ActiveSimulation.Options.SelectedComponents.Values
        ...
        For Each cs As Auxiliary.ComponentSeparationSpec In Me.compspecs.Values
            ...
            End Select
            If My.Application.ActiveSimulation.Options.SelectedComponents.ContainsKey(cs.ComponentID) Then Me.DataGridView1.Rows.Add(New Object() {cs.ComponentID, DWSIM.App.GetComponentName(cs.ComponentID), spec, cs.SpecValue, cs.SpecUnit})
        Next

...
Public Class UIMVSelectorForm

    Inherits System.Windows.Forms.Form

    Public formC As FormFlowsheet
    Public selectionData As DWSIM.SimulationObjects.SpecialOps.Helpers.Adjust.ManipulatedObjectInfo
    Public gi As GridItem

    Private Sub FormSpec_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Select Case TreeView1.SelectedNode.Index
                Case 0
                    For Each obj In formC.Collections.MaterialStreamCollection.Values
                        If obj.Calculated Then .Add(obj.Name, obj.Tag).Tag = obj.Name
                    Next
                Case 1
    ...
    Private Sub ListBox2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.TreeViewEventArgs) Handles TreeView2.AfterSelect
        ...
        With TreeView3.Nodes
            ...
            Dim properties As String() = formC.Collections.ObjectCollection(key).GetProperties(SimulationObjects_BaseClass.PropertyType.WR)

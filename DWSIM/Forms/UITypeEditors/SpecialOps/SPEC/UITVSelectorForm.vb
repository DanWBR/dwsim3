...
Public Class UITVSelectorForm
    ...
    Public selectionData As DWSIM.SimulationObjects.SpecialOps.Helpers.Spec.TargetObjectInfo
    Public gi As GridItem

    Private Sub UITVSelectorForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub KryptonButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles KryptonButton1.Click
        ...
        If formC.Collections.ObjectCollection.ContainsKey(Me.selectionData.m_ID) Then
            With formC.Collections.ObjectCollection(Me.selectionData.m_ID)
                ...
                .SpecVarType = DWSIM.SimulationObjects.SpecialOps.Helpers.Spec.TipoVar.Destino
            End With
        End If

...
Public Class UIResultsForm
    ...
    Private Sub FillGraphs()
        ...
        With Me.GraphConc.GraphPane
            .CurveList.Clear()
            For i = 0 To nc
                With .AddCurve("[L] " & DWSIM.App.GetComponentName(dc.compids(i)), cxm(i), py, Color.White, ZedGraph.SymbolType.Circle)
            ...
            Next
            For i = 0 To nc
                With .AddCurve("[V] " & DWSIM.App.GetComponentName(dc.compids(i)), cym(i), py, Color.White, ZedGraph.SymbolType.Square)
                    .Color = Color.FromArgb(255, rnd.Next(0, 255), rnd.Next(0, 255), rnd.Next(0, 255))
                    .Line.IsSmooth = False
                    .Symbol.Fill.Type = ZedGraph.FillType.Solid
                    .IsX2Axis = False

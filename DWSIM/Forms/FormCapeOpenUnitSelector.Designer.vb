...
Partial Class FormCapeOpenUnitSelector
    ...
    Private Sub InitializeComponent()
        ...
        'lblAuthorURL
        '
        resources.ApplyResources(Me.lblAuthorURL, "lblAuthorURL")
        Me.lblAuthorURL.Name = "lblAuthorURL"
        '
        'lblHelpURL
        '
        ...
        'lblCOversion
        '
        resources.ApplyResources(Me.lblCOversion, "lblCOversion")
        Me.lblCOversion.Name = "lblCOversion"
        '
        'txtDesc
        '
        ...
        Me.Controls.Add(Me.lblCOversion)
        Me.Controls.Add(Me.Label7)
        Me.Controls.Add(Me.btnCancel)
        Me.Controls.Add(Me.btnOK)
        Me.Controls.Add(Me.lblHelpURL)
        Me.Controls.Add(Me.lblAuthorURL)

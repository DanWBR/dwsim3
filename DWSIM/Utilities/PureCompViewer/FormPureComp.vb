...
Public Class FormPureComp
    ...
    Sub Populate()
        ...
        With Me.GridProps.Rows
            ...
            .Add(New Object() {DWSIM.App.GetLocalString("BlackOil_GOR"), Format(cv.ConverterDoSI(su.gor, constprop.BO_GOR), nf), su.gor})
            .Add(New Object() {DWSIM.App.GetLocalString("BlackOil_BSW"), Format(constprop.BO_BSW, nf), ""})
            .Add(New Object() {DWSIM.App.GetLocalString("BlackOil_V1"), Format(cv.ConverterDoSI(su.spmp_cinematic_viscosity, constprop.BO_OilVisc1), nf), su.spmp_cinematic_viscosity})
            .Add(New Object() {DWSIM.App.GetLocalString("BlackOil_T1"), Format(cv.ConverterDoSI(su.spmp_temperature, constprop.BO_OilViscTemp1), nf), su.spmp_temperature})
            .Add(New Object() {DWSIM.App.GetLocalString("BlackOil_V2"), Format(cv.ConverterDoSI(su.spmp_cinematic_viscosity, constprop.BO_OilVisc2), nf), su.spmp_cinematic_viscosity})
            .Add(New Object() {DWSIM.App.GetLocalString("BlackOil_T2"), Format(cv.ConverterDoSI(su.spmp_temperature, constprop.BO_OilViscTemp2), nf), su.spmp_temperature})
    ...
    Private Sub GridProps_CellEndEdit(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles GridProps.CellEndEdit
        ...
        Select Case e.RowIndex
            ...
            Case 35 '    .Add(New Object() {DWSIM.App.GetLocalString("BlackOil_GOR"), Format(cv.ConverterDoSI(su.gor, constprop.BO_GOR), nf), su.gor})
                constprop.BO_GOR = cv.ConverterParaSI(su.gor, GridProps.Rows(e.RowIndex).Cells(1).Value)
            ...
            Case 37 '         .Add(New Object() {DWSIM.App.GetLocalString("BlackOil_V1"), Format(cv.ConverterDoSI(su.spmp_cinematic_viscosity, constprop.Electrolyte_DelGF), nf), su.spmp_cinematic_viscosity})
                constprop.BO_OilVisc1 = cv.ConverterParaSI(su.spmp_cinematic_viscosity, GridProps.Rows(e.RowIndex).Cells(1).Value)
            Case 38 '         .Add(New Object() {DWSIM.App.GetLocalString("BlackOil_T1"), Format(cv.ConverterDoSI(su.spmp_temperature, constprop.Electrolyte_DelGF), nf), su.spmp_temperature})
                constprop.BO_OilViscTemp1 = cv.ConverterParaSI(su.spmp_temperature, GridProps.Rows(e.RowIndex).Cells(1).Value)
            Case 39 '         .Add(New Object() {DWSIM.App.GetLocalString("BlackOil_V2"), Format(cv.ConverterDoSI(su.spmp_cinematic_viscosity, constprop.Electrolyte_DelGF), nf), su.spmp_cinematic_viscosity})
                constprop.BO_OilVisc2 = cv.ConverterParaSI(su.spmp_cinematic_viscosity, GridProps.Rows(e.RowIndex).Cells(1).Value)
            Case 40 '         .Add(New Object() {DWSIM.App.GetLocalString("BlackOil_T2"), Format(cv.ConverterDoSI(su.spmp_temperature, constprop.Electrolyte_DelGF), nf), su.spmp_temperature})
                constprop.BO_OilViscTemp2 = cv.ConverterParaSI(su.spmp_temperature, GridProps.Rows(e.RowIndex).Cells(1).Value)

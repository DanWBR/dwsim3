...
Public Class FormBinEnv
    ...
    Private Sub FormBinEnv_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            MessageBox.Show(DWSIM.App.GetLocalString("Esteutilitriospodese"), DWSIM.App.GetLocalString("Erro"), MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Close()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Not Me.ComboBox3.SelectedItem Is Nothing Then
            ...
            Me.LblSelected.Text = gobj.Tag

            P = mat.Fases(0).SPMProperties.pressure.GetValueOrDefault
            T = mat.Fases(0).SPMProperties.temperature.GetValueOrDefault
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        Dim c(1) As String
        Dim i As Integer = 0
        For Each comp As DWSIM.ClassesBasicasTermodinamica.ConstantProperties In Frm.Options.SelectedComponents.Values
            c(i) = Global.DWSIM.DWSIM.App.GetComponentName(comp.Name)
            i = i + 1
        Next
        ...
        If Me.RadioButton1.Checked Then
            ...
            Dim px, py1, py2, pxi, py1i, py2i As ArrayList
            px = r(0)
            py1 = r(1)
            py2 = r(2)
            pxi = r2(0)
            ...
            Dim vx1, vx2, vy1, vy2, vxi, vy1i, vy2i As New ArrayList
            ...
            With Me.GraphControl.GraphPane
                ...
                With .AddCurve(DWSIM.App.GetLocalString("Ideal"), vxi.ToArray(GetType(Double)), vy2i.ToArray(GetType(Double)), Color.SlateBlue, ZedGraph.SymbolType.Circle)
                    ...
                    .Symbol.IsVisible = False
                End With
                .XAxis.Title.Text = DWSIM.App.GetLocalString("FracaoMolar3") & c(0)
        ...
        ElseIf Me.RadioButton2.Checked Then
            ...
            With Me.Grid1.Columns
                .Clear()
                .Add("c1", "x (" & c(0) & ")")
                .Add("c2", "Pbub (" & su.spmp_temperature & ")")
                .Add("c3", "x (" & c(0) & ")")
                .Add("c4", "Pdew (" & su.spmp_temperature & ")")
            End With
            For Each co As DataGridViewColumn In Me.Grid1.Columns
                co.SortMode = DataGridViewColumnSortMode.NotSortable
                co.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        ...
        ElseIf Me.RadioButton3.Checked Then
            ...
            Dim px, py, pxi, pyi As ArrayList
            px = r(0)
            py = r(1)
            pxi = r2(0)
            pyi = r2(1)

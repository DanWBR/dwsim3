    ...
    Public Function GetPropertyPackage(ByVal PackageName As String) As ICapeThermoPropertyRoutine Implements ICapeThermoPropertyPackageManager.GetPropertyPackage
        ...
        Select Case PackageName
            Case "FPROPS"
                ...
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescFPP")
            Case "CoolProp"
                pp = New CoolPropPropertyPackage(True)
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescCPPP")
            Case "PC-SAFT"
                pp = New PCSAFTPropertyPackage(True)
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescPCSAFTPP")
            Case "Peng-Robinson (PR)"
                pp = New PengRobinsonPropertyPackage(True)
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescPengRobinsonPP")
            Case "Peng-Robinson-Stryjek-Vera 2 (PRSV2-M)", "Peng-Robinson-Stryjek-Vera 2 (PRSV2)"
                pp = New PRSV2PropertyPackage(True)
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescPRSV2PP")
            Case "Peng-Robinson-Stryjek-Vera 2 (PRSV2-VL)"
                pp = New PRSV2VLPropertyPackage(True)
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescPRSV2VLPP")
            Case "Soave-Redlich-Kwong (SRK)"
                pp = New SRKPropertyPackage(True)
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescSoaveRedlichKwongSRK")
            Case "Peng-Robinson / Lee-Kesler (PR/LK)"
                pp = New PengRobinsonLKPropertyPackage(True)
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescPRLK")
            Case "UNIFAC"
                pp = New UNIFACPropertyPackage(True)
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescUPP")
            Case "UNIFAC-LL"
                pp = New UNIFACLLPropertyPackage(True)
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescUPP")
            Case "NRTL"
                pp = New NRTLPropertyPackage(True)
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescNRTLPP")
            Case "UNIQUAC"
                pp = New UNIQUACPropertyPackage(True)
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescUNIQUACPP")
            ...
            Case "Grayson-Streed"
                ...
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescGSLKPP")
            Case "Lee-Kesler-Plöcker"
                pp = New LKPPropertyPackage(True)
                pp.ComponentDescription = DWSIM.App.GetLocalString("DescLKPPP")
            Case "Raoult's Law"

...
Namespace DWSIM.SimulationObjects.PropertyPackages
    ...
    <System.Serializable()> Public Class ChaoSeaderPropertyPackage
        ...
        Public m_cs As New DWSIM.SimulationObjects.PropertyPackages.Auxiliary.CS
...
#End Region
        ...
        Public Overrides Function DW_CalcFugCoeff(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double()
            ...
            DWSIM.App.WriteToConsole("Chao-Seader fugacity calculation results at T = " & T & " K and P = " & P & " Pa: ", 2)

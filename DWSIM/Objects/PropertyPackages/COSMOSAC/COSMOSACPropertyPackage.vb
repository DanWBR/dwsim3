...
Namespace DWSIM.SimulationObjects.PropertyPackages
    ...
    <System.Runtime.InteropServices.Guid(COSMOSACPropertyPackage.ClassId)> _
      <System.Serializable()> Public Class COSMOSACPropertyPackage
        ...
        Public m_uni As New DWSIM.SimulationObjects.PropertyPackages.Auxiliary.COSMO_SAC
...
#End Region
        ...
        Public Overrides Function DW_CalcFugCoeff(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double()
            ...
            DWSIM.App.WriteToConsole("COSMO-SAC fugacity calculation requested at T = " & T & " K and P = " & P & " Pa for the following compounds: ", 2)
            ...
            If st = State.Liquid Then
                ativ = Me.m_uni.GAMMA_MR(T, Vx, Me.RET_VCSACIDS)
                For i = 0 To n
                    If T / Tc(i) >= 1 Then
            ...
            DWSIM.App.WriteToConsole("COSMO-SAC fugacity calculation results at T = " & T & " K and P = " & P & " Pa: ", 2)

                    ...
                    If id1 <> id2 Then
                        ...
                        If Me.UnifGroups.InteracParam.ContainsKey(g1) Then
                            If Not Me.UnifGroups.InteracParam(g1).ContainsKey(g2) Then
                                Throw New ArgumentOutOfRangeException("UNIFAC Error: Could not find interaction parameter for groups " & Me.UnifGroups.Groups(id1 + 1).GroupName & " / " & _
                                                    Me.UnifGroups.Groups(id2 + 1).GroupName & ". Activity coefficient calculation will give you unrealistic results for this system!")
                            End If
                        Else
                            Throw New ArgumentOutOfRangeException("UNIFAC Error: Could not find interaction parameter for groups " & Me.UnifGroups.Groups(id1 + 1).GroupName & " / " & _
                                                Me.UnifGroups.Groups(id2 + 1).GroupName & ". Activity coefficient calculation will give you unrealistic results for this system!")

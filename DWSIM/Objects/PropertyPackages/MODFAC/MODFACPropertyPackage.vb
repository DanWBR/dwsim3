...
Namespace DWSIM.SimulationObjects.PropertyPackages
    ...
    <System.Runtime.InteropServices.Guid(MODFACPropertyPackage.ClassId)> _
     <System.Serializable()> Public Class MODFACPropertyPackage
        ...
        Private m_uni As New DWSIM.SimulationObjects.PropertyPackages.Auxiliary.Modfac
...
#Region "    Auxiliary Functions"
        ...
        Function RET_VR() As Object
            ...
            For Each subst In Me.CurrentMaterialStream.Fases(0).Componentes.Values
                sum = 0
                For Each s As String In subst.ConstantProperties.MODFACGroups.Collection.Keys
                    sum += subst.ConstantProperties.MODFACGroups.Collection(s) * Me.m_uni.ModfGroups.Groups(s).R
                Next
                VR(i) = sum
                i += 1
            Next
...
#End Region
        ...
        Public Overrides Function DW_CalcFugCoeff(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double()
            ...
            DWSIM.App.WriteToConsole("Modified UNIFAC fugacity calculation requested at T = " & T & " K and P = " & P & " Pa for the following compounds: ", 2)
            ...
            DWSIM.App.WriteToConsole("Modified UNIFAC fugacity calculation results at T = " & T & " K and P = " & P & " Pa: ", 2)

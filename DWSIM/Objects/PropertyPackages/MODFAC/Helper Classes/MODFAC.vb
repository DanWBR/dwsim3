                            ...
                            If Not Me.ModfGroups.InteracParam_aij(g1).ContainsKey(g2) Then
                                If Me.ModfGroups.InteracParam_aij.ContainsKey(g2) Then
                                    If Not Me.ModfGroups.InteracParam_aij(g2).ContainsKey(g1) Then
                                        Throw New ArgumentOutOfRangeException("Modified UNIFAC Error: Could not find interaction parameter for groups " & Me.ModfGroups.Groups(id1 + 1).GroupName & " / " & _
                                                                                     Me.ModfGroups.Groups(id2 + 1).GroupName & ". Activity coefficient calculation will give you unrealistic results for this system!")
                                    End If
                                Else
                                    Throw New ArgumentOutOfRangeException("Modified UNIFAC Error: Could not find interaction parameter for groups " & Me.ModfGroups.Groups(id1 + 1).GroupName & " / " & _
                                                                                    Me.ModfGroups.Groups(id2 + 1).GroupName & ". Activity coefficient calculation will give you unrealistic results for this system!")

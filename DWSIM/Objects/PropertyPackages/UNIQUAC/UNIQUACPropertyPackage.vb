                ...
                Case "heatcapacity", "heatcapacitycp"
                    ...
                    Else
                        Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                            ...
                            Case 2 'Excess
                                result = Me.AUX_LIQCPm(T, phaseID) + Me.m_uni.CPEX_MIX(T, RET_VMOL(phase), Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(phase)
                        End Select
                    End If
                ...
                Case "enthalpy", "enthalpynf"
                    ...
                    Else
                        Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                            ...
                            Case 2 'Excess
                                result = Me.RET_Hid_L(298.15, T, RET_VMOL(phase)) + Me.m_uni.HEX_MIX(T, RET_VMOL(phase), Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(phase) - Me.RET_HVAPM(RET_VMAS(phase), T)
                        End Select
                    End If
                ...
                Case "entropy", "entropynf"
                    ...
                    Else
                        Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                            ...
                            Case 2 'Excess
                                result = (Me.RET_Hid_L(298.15, T, RET_VMOL(phase)) + Me.m_uni.HEX_MIX(T, RET_VMOL(phase), Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR)) / Me.AUX_MMM(phase) / T - Me.RET_HVAPM(RET_VMAS(phase), T) / T
                        End Select
                    End If
                    ...
                    Else
                        Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                            ...
                            Case 1 'Ideal
                                result = 0.0#
                            Case 2 'Excess
                                result = Me.m_uni.HEX_MIX(T, RET_VMOL(phase), Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(phase)
                        End Select
                    End If
                    ...
                    Else
                        Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                            ...
                            Case 1 'Ideal
                                result = 0.0#
                            Case 2 'Excess
                                result = Me.m_uni.HEX_MIX(T, RET_VMOL(phase), Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(phase) / T
                        End Select
                    End If
        ...
        Public Overrides Sub DW_CalcPhaseProps(ByVal fase As DWSIM.SimulationObjects.PropertyPackages.Fase)
            ...
            If phaseID = 3 Or phaseID = 4 Or phaseID = 5 Or phaseID = 6 Then
                ...
                Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                    ...
                    Case 2 'Excess
                        result = Me.RET_Hid_L(298.15, T, RET_VMOL(dwpl)) + Me.m_uni.HEX_MIX(T, RET_VMOL(dwpl), Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(dwpl) - Me.RET_HVAPM(RET_VMAS(dwpl), T)
                End Select
                Me.CurrentMaterialStream.Fases(phaseID).SPMProperties.enthalpy = result
                Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                    Case 0 'LK
                    ...
                    Case 2 'Excess
                        result = (Me.RET_Hid_L(298.15, T, RET_VMOL(dwpl)) + Me.m_uni.HEX_MIX(T, RET_VMOL(dwpl), Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR)) / Me.AUX_MMM(dwpl) / T - Me.RET_HVAPM(RET_VMAS(dwpl), T) / T
                End Select
                Me.CurrentMaterialStream.Fases(phaseID).SPMProperties.entropy = result
                ...
                Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                    ...
                    Case 1 'Ideal
                        ...
                        Me.CurrentMaterialStream.Fases(phaseID).SPMProperties.heatCapacityCv = result
                    Case 2 'Excess
                        result = Me.AUX_LIQCPm(T, phaseID) + Me.m_uni.CPEX_MIX(T, RET_VMOL(dwpl), Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(dwpl)
                        Me.CurrentMaterialStream.Fases(phaseID).SPMProperties.heatCapacityCp = result
                        Me.CurrentMaterialStream.Fases(phaseID).SPMProperties.heatCapacityCv = result
                End Select
        ...
        Public Overrides Function DW_CalcEnthalpy(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            If st = State.Liquid Then
                Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                    ...
                    Case 2 'Excess
                        H = Me.RET_Hid_L(298.15, T, Vx) + Me.m_uni.HEX_MIX(T, Vx, Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(Vx) - Me.RET_HVAPM(Me.AUX_CONVERT_MOL_TO_MASS(Vx), T)
                End Select
            Else
            ...
            If st = State.Liquid Then
                Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                    ...
                    Case 1 'Ideal
                        H = 0.0#
                    Case 2 'Excess
                        H = Me.m_uni.HEX_MIX(T, Vx, Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(Vx)
                End Select
            Else
        ...
        Public Overrides Function DW_CalcEntropy(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            If st = State.Liquid Then
                Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                    ...
                    Case 2 'Excess
                        S = (Me.RET_Hid_L(298.15, T, Vx) + Me.m_uni.HEX_MIX(T, Vx, Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(Vx)) / T - Me.RET_HVAPM(Me.AUX_CONVERT_MOL_TO_MASS(Vx), T) / T
                End Select
            Else
            ...
            If st = State.Liquid Then
                Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                    ...
                    Case 1 'Ideal
                        S = 0.0#
                    Case 2 'Excess
                        S = (Me.m_uni.HEX_MIX(T, Vx, Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(Vx)) / T
                End Select
            Else

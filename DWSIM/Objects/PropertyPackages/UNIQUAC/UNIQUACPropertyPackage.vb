...
#End Region
        ...
        Public Overrides Function DW_CalcEnthalpyDeparture(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            If st = State.Liquid Then
                Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                    ...
                    Case 2 'Excess
                        H = Me.m_uni.HEX_MIX(T, Vx, Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(Vx) - Me.RET_HVAPM(Me.AUX_CONVERT_MOL_TO_MASS(Vx), T)
                End Select
            Else
        ...
        Public Overrides Function DW_CalcEntropyDeparture(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            If st = State.Liquid Then
                Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                    ...
                    Case 2 'Excess
                        S = (Me.m_uni.HEX_MIX(T, Vx, Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(Vx)) / T - Me.RET_HVAPM(Me.AUX_CONVERT_MOL_TO_MASS(Vx), T) / T
                End Select
            Else
        ...
        Public Overrides Function DW_CalcFugCoeff(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double()
            ...
            DWSIM.App.WriteToConsole("UNIQUAC fugacity calculation requested at T = " & T & " K and P = " & P & " Pa for the following compounds: ", 2)
            ...
            DWSIM.App.WriteToConsole("UNIQUAC fugacity calculation results at T = " & T & " K and P = " & P & " Pa: ", 2)

                ...
                Case "enthalpy", "enthalpynf"
                    ...
                    Else
                        Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                            ...
                            Case 2 'Excess
                                result = Me.RET_Hid_L(298.15, T, RET_VMOL(phase)) + Me.m_uni.HEX_MIX(T, RET_VMOL(phase), Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(phase)
                        End Select
                    End If
                ...
                Case "entropy", "entropynf"
                    ...
                    Else
                        Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                            ...
                            Case 2 'Excess
                                result = (Me.RET_Hid_L(298.15, T, RET_VMOL(phase)) + Me.m_uni.HEX_MIX(T, RET_VMOL(phase), Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR)) / Me.AUX_MMM(phase) / T
                        End Select
                    End If
        ...
        Public Overrides Sub DW_CalcPhaseProps(ByVal fase As DWSIM.SimulationObjects.PropertyPackages.Fase)
            ...
            If phaseID = 3 Or phaseID = 4 Or phaseID = 5 Or phaseID = 6 Then
                ...
                Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                    ...
                    Case 2 'Excess
                        result = Me.RET_Hid_L(298.15, T, RET_VMOL(dwpl)) + Me.m_uni.HEX_MIX(T, RET_VMOL(dwpl), Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(dwpl)
                End Select
                Me.CurrentMaterialStream.Fases(phaseID).SPMProperties.enthalpy = result
                Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                    Case 0 'LK
                    ...
                    Case 2 'Excess
                        result = (Me.RET_Hid_L(298.15, T, RET_VMOL(dwpl)) + Me.m_uni.HEX_MIX(T, RET_VMOL(dwpl), Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR)) / Me.AUX_MMM(dwpl) / T
                End Select
                Me.CurrentMaterialStream.Fases(phaseID).SPMProperties.entropy = result
        ...
        Public Overrides Function DW_CalcEnthalpy(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            If st = State.Liquid Then
                Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                    ...
                    Case 2 'Excess
                        H = Me.RET_Hid_L(298.15, T, Vx) + Me.m_uni.HEX_MIX(T, Vx, Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(Vx)
                End Select
            Else
        ...
        Public Overrides Function DW_CalcEntropy(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            If st = State.Liquid Then
                Select Case Me.Parameters("PP_ENTH_CP_CALC_METHOD")
                    ...
                    Case 2 'Excess
                        S = (Me.RET_Hid_L(298.15, T, Vx) + Me.m_uni.HEX_MIX(T, Vx, Me.RET_VNAMES, Me.RET_VQ, Me.RET_VR) / Me.AUX_MMM(Vx)) / T
                End Select
            Else

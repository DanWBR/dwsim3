            ...
            Get
                ...
                Select Case FlashAlgorithm
                    ...
                    Case FlashMethod.GibbsMin2P
                        Dim optm As DWSIM.Optimization.OptimizationMethod = Optimization.OptimizationMethod.IPOPT
                        If Not Me.CurrentMaterialStream Is Nothing Then
                            If Not Me.CurrentMaterialStream.FlowSheet Is Nothing Then
                                optm = Me.CurrentMaterialStream.FlowSheet.Options.PreferredGibbsMinimizationMethod
                            End If
                        End If

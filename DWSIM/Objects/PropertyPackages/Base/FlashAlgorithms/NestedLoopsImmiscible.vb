...
Namespace DWSIM.SimulationObjects.PropertyPackages.Auxiliary.FlashAlgorithms
    ...
    <System.Serializable()> Public Class NestedLoopsImmiscible
        ...
        Public Overrides Function Flash_PT(ByVal Vz As Double(), ByVal P As Double, ByVal T As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object
            ...
            Console.WriteLine("PT Flash [NL-I]: Converged in " & ecount & " iterations. Time taken: " & dt.Milliseconds & " ms.")
...
alt:            T = bo.BrentOpt(Tinf, Tsup, 10, tolEXT, maxitEXT, {P, Vz, PP})
            ...
            Console.WriteLine("PH Flash [NL-I]: Converged in " & ecount & " iterations. Time taken: " & dt.Milliseconds & " ms.")
...
alt:            T = bo.BrentOpt(Tinf, Tsup, 10, tolEXT, maxitEXT, {P, Vz, PP})
            ...
            Console.WriteLine("PS Flash [NL-I]: Converged in " & ecount & " iterations. Time taken: " & dt.Milliseconds & " ms.")
        ...
        Public Overrides Function Flash_TV(ByVal Vz As Double(), ByVal T As Double, ByVal V As Double, ByVal Pref As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object
            ...
            Console.WriteLine("TV Flash [NL-I]: Converged in " & ecount & " iterations. Time taken: " & dt.Milliseconds & " ms.")
        ...
        Public Overrides Function Flash_PV(ByVal Vz As Double(), ByVal P As Double, ByVal V As Double, ByVal Tref As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object
            ...
            Console.WriteLine("PV Flash [NL-I]: Converged in " & ecount & " iterations. Time taken: " & dt.Milliseconds & " ms.")

            ...
            Do
                ...
                If ecount = 0 Then
                    For i = 0 To n
                        ...
                        Next
                    Next
                    broydn(n, x, fx, dx, xbr, fbr, dfdx, 0)
                Else
                    broydn(n, x, fx, dx, xbr, fbr, dfdx, 1)
                End If
...
restart:    Do
                ...
                If ecount = 0 Then
                    For i = 0 To n + 6
                        ...
                        Next
                    Next
                    broydn(n + 6, x, fx, dx, xbr, fbr, dfdx, 0)
                Else
                    broydn(n + 6, x, fx, dx, xbr, fbr, dfdx, 1)
                End If
            ...
            Do
                ...
                If ecount = 0 Then
                    For i = 0 To n + 2
                        ...
                        Next
                    Next
                    broydn(n + 2, x, fx, dx, xbr, fbr, dfdx, 0)
                Else
                    broydn(n + 2, x, fx, dx, xbr, fbr, dfdx, 1)
                End If

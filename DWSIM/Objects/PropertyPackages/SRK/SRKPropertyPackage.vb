...
#End Region
        ...
        Public Overrides Function AUX_VAPDENS(ByVal T As Double, ByVal P As Double) As Double
            ...
            Dim val As Double
            val = m_pr.Z_SRK(T, P, RET_VMOL(Fase.Vapor), RET_VKij(), RET_VTC, RET_VPC, RET_VW, "V")
            val = (8.314 * val * T / P)
            If CInt(Me.Parameters("PP_USE_EOS_VOLUME_SHIFT")) = 1 Then
        ...
        Public Overrides Function DW_ReturnPhaseEnvelope(ByVal parameters As Object) As Object
            ...
            Do
                If i < 2 Then
                    ...
                    VB.Add(Me.m_pr.Z_SRK(T, P, Me.RET_VMOL(Fase.Mixture), Me.RET_VKij, Me.RET_VTC, Me.RET_VPC, Me.RET_VW, "L") * 8.314 * T / P)
                    P = P + dP
                    KI = tmp2(6)
                Else
                    If beta < 20 Then
            ...
            Do
                If i < 2 Then
                    ...
                    VO.Add(Me.m_pr.Z_SRK(T, P, Me.RET_VMOL(Fase.Mixture), Me.RET_VKij, Me.RET_VTC, Me.RET_VPC, Me.RET_VW, "V") * 8.314 * T / P)
                    If Math.Abs(T - TCR) / TCR < 0.01 And Math.Abs(P - PCR) / PCR < 0.01 Then
                        P = P + dP * 0.1
                    Else
                        P = P + dP

        ...
        Public Overrides Function DW_ReturnPhaseEnvelope(ByVal parameters As Object) As Object
            ...
            Do
                If i < 2 Then
                    ...
                    VB.Add(Me.m_pr.CalcZ(RET_VMOL(Fase.Mixture), RET_VKij(), T, P, RET_VCAS, "L") * 8.314 * T / P)
                    P = P + dP
                    KI = tmp2(6)
                Else
                    If beta < 20 Then
            ...
            Do
                If i < 2 Then
                    ...
                    VO.Add(Me.m_pr.CalcZ(RET_VMOL(Fase.Mixture), RET_VKij(), T, P, RET_VCAS, "V") * 8.314 * T / P)
                    If Math.Abs(T - TCR) / TCR < 0.01 And Math.Abs(P - PCR) / PCR < 0.01 Then
                        P = P + dP * 0.1
                    Else
                        P = P + dP

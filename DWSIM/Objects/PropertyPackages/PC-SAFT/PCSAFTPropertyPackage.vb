...
Namespace DWSIM.SimulationObjects.PropertyPackages
 ...
 <System.Serializable()> Public Class PCSAFTPropertyPackage
        ...
        Public m_pr As New DWSIM.SimulationObjects.PropertyPackages.Auxiliary.PCSAFT
        ...
        Public Sub New()
            ...
            Me.ConfigForm = New FormConfigPCSAFT
...
#Region "    DWSIM Functions"
        ...
        Public Overrides Function DW_CalcCp_ISOL(ByVal fase1 As DWSIM.SimulationObjects.PropertyPackages.Fase, ByVal T As Double, ByVal P As Double) As Double
            Select Case fase1
                Case Fase.Liquid
                    Return Me.m_pr.CalcCp("L", T, P, RET_VMOL(fase1), RET_VKij(), RET_VMM, RET_VCAS, Me.AUX_CPm(fase1, T))
                Case Fase.Aqueous
                    Return Me.m_pr.CalcCp("L", T, P, RET_VMOL(fase1), RET_VKij(), RET_VMM, RET_VCAS, Me.AUX_CPm(fase1, T))
                Case Fase.Liquid1
                    Return Me.m_pr.CalcCp("L", T, P, RET_VMOL(fase1), RET_VKij(), RET_VMM, RET_VCAS, Me.AUX_CPm(fase1, T))
                ...
                Case Fase.Liquid3
                    Return Me.m_pr.CalcCp("L", T, P, RET_VMOL(fase1), RET_VKij(), RET_VMM, RET_VCAS, Me.AUX_CPm(fase1, T))
                Case Fase.Vapor
                    Return Me.m_pr.CalcCp("V", T, P, RET_VMOL(fase1), RET_VKij(), RET_VMM, RET_VCAS, Me.AUX_CPm(fase1, T))
            End Select
        End Function
        ...
        Public Overrides Function DW_CalcEnergiaMistura_ISOL(ByVal T As Double, ByVal P As Double) As Double
            ...
            HL = Me.m_pr.CalcHRES("L", T, P, RET_VMOL(Fase.Liquid), RET_VKij(), RET_VMM, RET_VCAS, Me.RET_Hid(298.15, T, Fase.Liquid))
            HV = Me.m_pr.CalcHRES("V", T, P, RET_VMOL(Fase.Vapor), RET_VKij(), RET_VTC, RET_VCAS, Me.RET_Hid(298.15, T, Fase.Vapor))
        ...
        Public Overrides Sub DW_CalcPhaseProps(ByVal fase As DWSIM.SimulationObjects.PropertyPackages.Fase)
            ...
            If phaseID = 3 Or phaseID = 4 Or phaseID = 5 Or phaseID = 6 Then
                ...
                If CInt(Me.Parameters("PP_USE_EOS_LIQDENS")) = 1 Then
                    Dim val As Double
                    val = m_pr.CalcZ(RET_VMOL(fase), RET_VKij(), T, P, RET_VCAS, "L")
                    val = 1 / (8.314 * val * T / P)
            ...
            ElseIf phaseID = 2 Then
                ...
                result = Me.AUX_VAPDENS(T, P)
                Me.CurrentMaterialStream.Fases(phaseID).SPMProperties.density = result
                result = Me.m_pr.CalcHRES("V", T, P, RET_VMOL(fase.Vapor), RET_VKij(), RET_VMM, RET_VCAS, Me.RET_Hid(298.15, T, fase.Vapor))
                Me.CurrentMaterialStream.Fases(phaseID).SPMProperties.enthalpy = result
                result = Me.m_pr.CalcSRES("V", T, P, RET_VMOL(fase.Vapor), RET_VKij(), RET_VMM, RET_VCAS, Me.RET_Sid(298.15, T, P, fase.Vapor))
                Me.CurrentMaterialStream.Fases(phaseID).SPMProperties.entropy = result
                result = Me.m_pr.CalcZ(RET_VMOL(PropertyPackages.Fase.Vapor), RET_VKij(), T, P, RET_VCAS, "V")
                Me.CurrentMaterialStream.Fases(phaseID).SPMProperties.compressibilityFactor = result
...
#End Region
        ...
        Public Overrides Function DW_CalcCv_ISOL(ByVal fase1 As Fase, ByVal T As Double, ByVal P As Double) As Double
            Select Case fase1
                Case Fase.Liquid
                    Return Me.m_pr.CalcCv("L", T, P, RET_VMOL(fase1), RET_VKij(), RET_VMM, RET_VCAS, Me.AUX_CPm(fase1, T))
                Case Fase.Aqueous
                    Return Me.m_pr.CalcCv("L", T, P, RET_VMOL(fase1), RET_VKij(), RET_VMM, RET_VCAS, Me.AUX_CPm(fase1, T))
                Case Fase.Liquid1
                    Return Me.m_pr.CalcCv("L", T, P, RET_VMOL(fase1), RET_VKij(), RET_VMM, RET_VCAS, Me.AUX_CPm(fase1, T))
                ...
                Case Fase.Liquid3
                    Return Me.m_pr.CalcCv("L", T, P, RET_VMOL(fase1), RET_VKij(), RET_VMM, RET_VCAS, Me.AUX_CPm(fase1, T))
                Case Fase.Vapor
                    Return Me.m_pr.CalcCv("V", T, P, RET_VMOL(fase1), RET_VKij(), RET_VMM, RET_VCAS, Me.AUX_CPm(fase1, T))
            End Select
        End Function
        ...
        Public Overrides Function AUX_VAPDENS(ByVal T As Double, ByVal P As Double) As Double
            Dim val As Double
            Dim Z As Double = Me.m_pr.CalcZ(RET_VMOL(Fase.Vapor), RET_VKij, T, P, RET_VCAS, "V")
        ...
        Public Overrides Function DW_CalcFugCoeff(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double()
            ...
            DWSIM.App.WriteToConsole("PC-SAFT fugacity calculation requested at T = " & T & " K and P = " & P & " Pa for the following compounds: ", 2)
            ...
            DWSIM.App.WriteToConsole("PC-SAFT fugacity calculation results at T = " & T & " K and P = " & P & " Pa: ", 2)

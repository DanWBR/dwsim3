...
redirect2:                      result = Me.FLASH_PS(T, S, P, RET_VMOL(Fase.Mixture), RET_VKij, RET_VTC, RET_VPC, RET_VTB, RET_VW)
                        ...
                        Case FlashSpec.VAP
                            ...
                            If xv = 0 Then
                                result = Me.BUBT_PR_M2(P, RET_VMOL(Fase.Mixture), RET_VKij, RET_VTC, RET_VPC, RET_VTB, RET_VW, KI, T)
                            ElseIf xv > 0 And xv < 1 Then
                                result = Me.FLASH_PV(P, xv, RET_VMOL(Fase.Mixture), RET_VKij, RET_VTC, RET_VPC, RET_VTB, RET_VW, KI, T)
                            ElseIf xv = 1 Then
                                result = Me.DEWT_PR_M2(P, RET_VMOL(Fase.Mixture), RET_VKij, RET_VTC, RET_VPC, RET_VTB, RET_VW, KI, T)
                            End If
                            ...
                            i = 0
                            Do
                                If RET_VMOL(Fase.Mixture)(i) <> 0 Then
                                    Vy(i) = RET_VMOL(Fase.Mixture)(i) * result(i + 1) / ((result(i + 1) - 1) * xv + 1)
                                    Vx(i) = RET_VMOL(Fase.Mixture)(i) / result(i + 1)
                                Else
                                    Vy(i) = 0
                                    Vx(i) = 0
                                End If

...
Public Class FormPCBulk
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles KButton3.Click
        ...
        Dim myMStr As New Microsoft.MSDN.Samples.GraphicObjects.MaterialStreamGraphic(frm.FormSurface.FlowsheetDesignSurface.HorizontalScroll.Value + 100, frm.FormSurface.FlowsheetDesignSurface.VerticalScroll.Value + 100, 20, 20, 0)
        myMStr.LineWidth = 2
        myMStr.Fill = True
